...
export async function handleChat({ prompt, history, sessionId, customerId, slug, isTestMode }) {
  ...
  // ============================================
  // STEP 10: Run analysis in background
  // ============================================
...
// BACKGROUND ANALYSIS
// ============================================
async function runAnalysisInBackground(sessionId, customer, aiConfig, analysisConfig, actions, conversation, aiResponse, isTestMode) {
  try {
